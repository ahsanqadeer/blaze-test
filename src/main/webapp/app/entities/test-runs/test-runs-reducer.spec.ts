...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './test-runs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRUNS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRUNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRUNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRUNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRUNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRUNS actions', async () => {
      const expectedActions = [
        {
