...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-case-attachments.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEATTACHMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEATTACHMENTS actions', async () => {
      const expectedActions = [
        {
