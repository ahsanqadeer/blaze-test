...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-case-priorities.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEPRIORITIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEPRIORITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEPRIORITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEPRIORITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEPRIORITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEPRIORITIES actions', async () => {
      const expectedActions = [
        {
