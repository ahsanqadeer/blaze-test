...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTPLANS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTPLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTPLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTPLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTPLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTPLANS actions', async () => {
      const expectedActions = [
        {
