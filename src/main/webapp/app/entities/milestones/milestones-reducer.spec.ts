...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MILESTONES_LIST actions', async () => {
    ...
    it('dispatches FETCH_MILESTONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MILESTONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MILESTONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MILESTONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MILESTONES actions', async () => {
      const expectedActions = [
        {
