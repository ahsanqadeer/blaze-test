...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-run-step-detail-attachments.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRUNSTEPDETAILATTACHMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRUNSTEPDETAILATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRUNSTEPDETAILATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRUNSTEPDETAILATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRUNSTEPDETAILATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRUNSTEPDETAILATTACHMENTS actions', async () => {
      const expectedActions = [
        {
