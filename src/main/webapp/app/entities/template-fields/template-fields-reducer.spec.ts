...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATEFIELDS actions', async () => {
      const expectedActions = [
        {
