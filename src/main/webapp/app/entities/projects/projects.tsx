          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Default Template <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {projectsList.map((projects, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{projects.updatedBy}</td>
                  <td>{projects.updatedAt ? <TextFormat type="date" value={projects.updatedAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
                    {projects.defaultTemplate ? (
                      <Link to={`/templates/${projects.defaultTemplate.id}`}>{projects.defaultTemplate.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>{projects.company ? <Link to={`/companies/${projects.company.id}`}>{projects.company.id}</Link> : ''}</td>
