...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTSUITES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTSUITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTSUITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTSUITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTSUITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTSUITES actions', async () => {
      const expectedActions = [
        {
