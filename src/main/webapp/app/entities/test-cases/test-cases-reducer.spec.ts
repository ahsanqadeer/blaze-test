...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASES actions', async () => {
      const expectedActions = [
        {
