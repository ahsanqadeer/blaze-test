...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTLEVELS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTLEVELS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTLEVELS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTLEVELS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTLEVELS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTLEVELS actions', async () => {
      const expectedActions = [
        {
