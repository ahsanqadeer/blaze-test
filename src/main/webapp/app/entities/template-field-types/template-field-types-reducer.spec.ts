...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './template-field-types.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELDTYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATEFIELDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATEFIELDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEFIELDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATEFIELDTYPES actions', async () => {
      const expectedActions = [
        {
