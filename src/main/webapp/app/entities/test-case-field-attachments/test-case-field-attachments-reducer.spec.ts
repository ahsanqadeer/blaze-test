...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-case-field-attachments.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEFIELDATTACHMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEFIELDATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEFIELDATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEFIELDATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEFIELDATTACHMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEFIELDATTACHMENTS actions', async () => {
      const expectedActions = [
        {
