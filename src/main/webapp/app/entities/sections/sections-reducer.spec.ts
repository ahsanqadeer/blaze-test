...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sections.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECTIONS actions', async () => {
      const expectedActions = [
        {
