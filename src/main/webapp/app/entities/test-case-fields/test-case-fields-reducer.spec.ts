...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEFIELDS actions', async () => {
      const expectedActions = [
        {
