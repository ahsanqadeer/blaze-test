            ...
            <tbody>
              {testRunDetailsList.map((testRunDetails, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {testRunDetails.testRun ? <Link to={`/test-runs/${testRunDetails.testRun.id}`}>{testRunDetails.testRun.id}</Link> : ''}
                  </td>
                  <td>
                    {testRunDetails.testCase ? (
                      <Link to={`/test-cases/${testRunDetails.testCase.id}`}>{testRunDetails.testCase.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>
                    {testRunDetails.status ? <Link to={`/test-statuses/${testRunDetails.status.id}`}>{testRunDetails.status.id}</Link> : ''}
                  </td>
