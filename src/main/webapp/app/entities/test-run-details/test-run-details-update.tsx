...
import { getEntities as getTestRuns } from 'app/entities/test-runs/test-runs.reducer';
...
import { getEntities as getTestStatuses } from 'app/entities/test-statuses/test-statuses.reducer';
...
export const TestRunDetailsUpdate = () => {
  ...
  const testRuns = useAppSelector(state => state.testRuns.entities);
  const testCases = useAppSelector(state => state.testCases.entities);
  const testStatuses = useAppSelector(state => state.testStatuses.entities);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blazeTestApp.testRunDetails.home.createOrEditLabel" data-cy="TestRunDetailsCreateUpdateHeading">
