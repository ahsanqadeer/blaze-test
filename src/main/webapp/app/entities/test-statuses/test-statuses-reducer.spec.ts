...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTSTATUSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTSTATUSES actions', async () => {
      const expectedActions = [
        {
