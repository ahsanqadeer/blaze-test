...
public class TemplatesRepositoryWithBagRelationshipsImpl implements TemplatesRepositoryWithBagRelationships {
    ...
    public Optional<Templates> fetchBagRelationships(Optional<Templates> templates) {
        return templates.map(this::fetchTemplateFields);
    }
    ...
    Templates fetchTemplateFields(Templates result) {
        return entityManager
            .createQuery(
                "select templates from Templates templates left join fetch templates.templateFields where templates is :templates",
                Templates.class
            )
    ...
    List<Templates> fetchTemplateFields(List<Templates> templates) {
        ...
        List<Templates> result = entityManager
            .createQuery(
                "select distinct templates from Templates templates left join fetch templates.templateFields where templates in :templates",
                Templates.class
            )
