...
import com.venturedive.blazetest.service.TestRunStepDetailsQueryService;
import com.venturedive.blazetest.service.TestRunStepDetailsService;
...
/**
 * REST controller for managing {@link com.venturedive.blazetest.domain.TestRunStepDetails}.
 */
@RestController
@RequestMapping("/api")
public class TestRunStepDetailsResource {
    ...
    public ResponseEntity<TestRunStepDetails> createTestRunStepDetails(@RequestBody TestRunStepDetails testRunStepDetails)
    ...
    public ResponseEntity<TestRunStepDetails> updateTestRunStepDetails(
        ...
        @RequestBody TestRunStepDetails testRunStepDetails
    ) throws URISyntaxException {
