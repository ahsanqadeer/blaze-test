...
/**
 * Criteria class for the {@link com.venturedive.blazetest.domain.TestRunDetails} entity. This class is used
 * in {@link com.venturedive.blazetest.web.rest.TestRunDetailsResource} to receive all the possible filtering options from
...
public class TestRunDetailsCriteria implements Serializable, Criteria {
    ...
    private LongFilter testrundetailattachmentsTestrundetailId;
    ...
    public TestRunDetailsCriteria(TestRunDetailsCriteria other) {
        ...
        this.testrundetailattachmentsTestrundetailId =
            other.testrundetailattachmentsTestrundetailId == null ? null : other.testrundetailattachmentsTestrundetailId.copy();
    ...
    public LongFilter getTestrundetailattachmentsTestrundetailId() {
        return testrundetailattachmentsTestrundetailId;
    }

    public LongFilter testrundetailattachmentsTestrundetailId() {
        if (testrundetailattachmentsTestrundetailId == null) {
            testrundetailattachmentsTestrundetailId = new LongFilter();
        }
        return testrundetailattachmentsTestrundetailId;
    }

    public void setTestrundetailattachmentsTestrundetailId(LongFilter testrundetailattachmentsTestrundetailId) {
        this.testrundetailattachmentsTestrundetailId = testrundetailattachmentsTestrundetailId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(testrundetailattachmentsTestrundetailId, that.testrundetailattachmentsTestrundetailId) &&
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            testCaseId,
            statusId,
            testrundetailattachmentsTestrundetailId,
    ...
    public String toString() {
        return "TestRunDetailsCriteria{" +
            ...
            (testrundetailattachmentsTestrundetailId != null ? "testrundetailattachmentsTestrundetailId=" + testrundetailattachmentsTestrundetailId + ", " : "") +
