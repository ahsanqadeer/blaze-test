...
/**
 * Criteria class for the {@link com.venturedive.blazetest.domain.TestStatuses} entity. This class is used
 * in {@link com.venturedive.blazetest.web.rest.TestStatusesResource} to receive all the possible filtering options from
...
public class TestStatusesCriteria implements Serializable, Criteria {
    ...
    public TestStatusesCriteria() {}

    public TestStatusesCriteria(TestStatusesCriteria other) {
    ...
    @Override
    public TestStatusesCriteria copy() {
        return new TestStatusesCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TestStatusesCriteria that = (TestStatusesCriteria) o;
        return (
